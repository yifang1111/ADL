...
def main():
    ...
    def preprocess_function(examples):
        ...
        # ]
        second_sentences = [[context_data[i] for i in para] for para in examples[paragraph_name]]
        if label_column_name in examples.keys():
            labels = [examples[paragraph_name][i].index(label) for i, label in enumerate(examples[label_column_name])]
        # Flatten out
    ...
    print("Save multiple choice results")
